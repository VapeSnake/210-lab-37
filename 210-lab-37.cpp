...
int main() {
    ...
    do {
        ...
        case 4: { // Deletes string from hash table by getting its index and removing it from list at index if it exists.
            string delStr;
            ...
            if (it != strList.end()) { // If the string is found, erase it from the list.
                strList.erase(it);
        ...
        case 5: { // Changes a string in hash table by deleting old string, adding new string, and displaying new index if it changes.
            ...
            if (it != strList.end()) { // If the old string is found, erase it and add the new string.
                ...
                if (oldHashIndex != newHashIndex) { // If the hash index changes, display the new index.
